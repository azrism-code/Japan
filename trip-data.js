/* Japan Trip 2026 · canonical data · v10.3.12
...
(() => {
  ...
  const days = [
    ...
    {date:'06/11',dow:'שישי',city:'Tokyo',title:'Meiji · Harajuku · Shibuya',summary:'Meiji Shrine → Harajuku → Omotesando → Shibuya → תצפית לפי הראות',hotel:'hotel-jr-kyushu-shinjuku',evening:'ueno',stops:[
      ...
      {time:'אופציה',icon:'🛍️',title:'Shibuya LOFT',text:'כלי כתיבה, קוסמטיקה, מתנות וגאדג׳טים יפניים.',place:'Shibuya LOFT',optional:true,tag:'🛍️ חנות אופציונלית'},
      {time:'אופציה',icon:'🛠️',title:'Hands Shibuya',text:'מוצרי בית, נסיעות, DIY וגאדג׳טים שימושיים.',place:'Hands Shibuya',optional:true,tag:'🛍️ חנות אופציונלית'},
  ...
  window.TRIP_DATA = {
    version:'10.3.12', title:'Japan Trip', year:2026, travelers:'עזרי ואיילי',
